...
public class HalApiClientFactory {

  public static HalApiClient createClient(JsonResourceLoader jsonLoader, BinaryResourceLoader binaryLoader, RequestMetricsCollector collector) {
