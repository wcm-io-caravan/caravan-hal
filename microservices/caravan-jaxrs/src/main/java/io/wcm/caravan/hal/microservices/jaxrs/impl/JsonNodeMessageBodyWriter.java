...
@Component
@Service(value = {
    JaxRsComponent.class, JsonNodeMessageBodyWriter.class
}, serviceFactory = true)
@Property(name = JaxRsComponent.PROPERTY_GLOBAL_COMPONENT, value = "true")
@Provider
@Produces({ HalResource.CONTENT_TYPE, MediaType.WILDCARD })
public class JsonNodeMessageBodyWriter implements MessageBodyWriter<JsonNode>, JaxRsComponent {
