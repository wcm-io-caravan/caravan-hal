...
/**
 * A processing step implements one aspect of the pre-processing of embedded resourced in
 * {@link EmbeddedProcessingImpl}, by performing one or more of the following actions:
 * <ul>
 * <li>find any differences in the two given lists *without looking into the resources itself</li>
...
public interface EmbeddedProcessingStep {
   ...
   */
  List<HalDifference> apply(HalComparisonContextImpl context, List<HalResource> expected, List<HalResource> actual);
}
